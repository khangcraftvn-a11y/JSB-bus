...
susuGreetSound.volume = 0.5;
const susuHelpSound = new Audio('./sound/susuHelp.wav');
susuHelpSound.volume = 0.5;
const susuNothingSound = new Audio('./sound/susuNothing.wav');
susuNothingSound.volume = 0.5;
const susuWinSound = new Audio('./sound/susuWin.wav');
susuWinSound.volume = 0.5;
const susuNotEnoughSound = new Audio('./sound/susuNotEnoughLunacy.wav');
susuNotEnoughSound.volume = 0.5;
const susuNotExistSound = new Audio('./sound/susuNotExist.wav');
susuNotExistSound.volume = 0.5;
const susuHadSound = new Audio('./sound/susuHad.wav');
susuHadSound.volume = 0.5;
const susuBalInSound = new Audio('./sound/susuBalIn.wav');
susuBalInSound.volume = 0.5;
const susuShopSound = new Audio('./sound/susuShop.wav');
susuShopSound.volume = 0.5;
const susuEquipSound = new Audio('./sound/susuEquip.wav');
susuEquipSound.volume = 0.5;
const susuUnequipSound = new Audio('./sound/susuUnequip.wav');
susuUnequipSound.volume = 0.5;
const susuSinnersSound = new Audio('./sound/susuSinners.wav');
susuSinnersSound.volume = 0.5;
const susuLimitSound = new Audio('./sound/susuLimit.wav');
...
const SANCHO_ICON = "./img/ryoshu.png";
const USER_ICON = "./img/araya.jpg";
...
const prescriptPool = [
    ...
    { text: "Chat with <b>me</b> for more 30 seconds.", id: "STAY" },
    ...
    { text: "Send 8 messages for <b>me</b>.", id: "MESSAGES" }
];
...
function endQuest(success, reward = true) {
    ...
    setTimeout(() => {
        if (success) {
            ...
            addMessage("Ryōshū", "<b>PRESCRIPT COMPLETED.</b>", "bot", SANCHO_ICON);
            if (reward) {
                addMessage("Ryōshū", "Earn <b>100 Lunacy</b>.", "bot", SANCHO_ICON);
                updateStorage(100);
            }
        } else {
            ...
            addMessage("Ryōshū", "<b>PRESCRIPT FAILED.</b>", "bot", SANCHO_ICON);
        }
    }, 1000);
}
...
function handleInput() {
    ...
    if (command === "hi" || command === "hello") {
        setTimeout(() => {
            addMessage("Ryōshū", "It’s <b>Ryōshū</b>. Shūre’s nice to meet ya. …Pft. <b>?help</b> for <b>Commands</b>.", "bot", SANCHO_ICON);
            stopAllSFX();
            susuGreetSound.play().catch(error => {
        ...
        setTimeout(() => {
            ...
            `;
            stopAllSFX();
            susuBalInSound.play().catch(error => {
                console.log("Audio play blocked.");
            });
            addMessage("Ryōshū", balHtml, "bot", SANCHO_ICON);
        }, 500);
    }
        ...
        window.shopTimeout = setTimeout(() => {
            ...
            <div style="background-color: #2b2d31; color: #dbdee1; padding: 15px; border-radius: 8px; font-family: 'Courier New', Courier, monospace; max-width: 320px; line-height: 1.4; text-align: left; border: 1px solid rgba(255,255,255,0.05);">
                <b style="color: white; font-size: 16px;">Ryōshū'S LUNACY SHOP</b><br>
            ...
            stopAllSFX();
            susuShopSound.play().catch(error => {
                console.log("Audio play blocked.");
            });
            addMessage("Ryōshū", shopHtml, "bot", SANCHO_ICON);
        }, 500);
    }
        ...
        setTimeout(() => {
            if (!item) {
                addMessage("Ryōshū", "Tch! That <b>nametag</b> does not exist in the shop.", "bot", SANCHO_ICON);
                stopAllSFX();
                susuNotExistSound.play().catch(error => {
                    console.log("Audio play blocked.");
                });
                return;
            }
            if (user.inventory && user.inventory[itemName]) {
                addMessage("Ryōshū", "You talk to me when you already have that <b>nametag</b>... Where’d you learn that <b>custom</b>?", "bot", SANCHO_ICON);
                stopAllSFX();
                susuHadSound.play().catch(error => {
                    console.log("Audio play blocked.");
                });
                return;
            }
            if ((user.lunacy || 0) < item.price) {
                addMessage("Ryōshū", "Don’t bother me if you aren’t having enough <b>Lunacy</b>.", "bot", SANCHO_ICON);
                stopAllSFX();
                susuNotEnoughSound.play().catch(error => {
                    console.log("Audio play blocked.");
                });
                return;
            }
    ...
    if (command === "?inv") {
        ...
        setTimeout(() => {
            if (user.inventory && user.inventory[itemName] > 0) {
                ...
                addMessage("Ryōshū", `The audience here is dull. A real work of art should open their eyes. Successfully equipped ${itemName}.`, "bot", SANCHO_ICON);
                stopAllSFX();
                susuEquipSound.play().catch(error => {
                    console.log("Audio play blocked.");
                });
            } else {
                addMessage("Ryōshū", `Don’t bother me if you aren’t having ${itemName}.`, "bot", SANCHO_ICON);
                stopAllSFX();
                susuNotEnoughSound.play().catch(error => {
                    console.log("Audio play blocked.");
                });
        ...
        setTimeout(() => {
            if (user.equippedTag) {
                ...
                addMessage("Ryōshū", `Not what I like to see. Successfully unequipped ${oldTag}.`, "bot", SANCHO_ICON);
                stopAllSFX();
                susuEquipSound.play().catch(error => {
                    console.log("Audio play blocked.");
                });
            } else {
                addMessage("Ryōshū", "Don’t bother me if you aren’t wearing any nametag.", "bot", SANCHO_ICON);
                stopAllSFX();
                susuNotEnoughSound.play().catch(error => {
                    console.log("Audio play blocked.");
                });
        ...
        setTimeout(() => {
            ...
            addMessage("Ryōshū", collectionHtml, "bot", SANCHO_ICON);
            stopAllSFX();
            susuSinnersSound.play().catch(error => {
                console.log("Audio play blocked.");
            });
        }, 500);
    }
        ...
        setTimeout(() => {
            ...
            if (chance < 0.65) {
                addMessage("Ryōshū", `<b>Nothing</b>? Anyways, I did as I was told.`, "bot", SANCHO_ICON);
                stopAllSFX();
                susuNothingSound.play().catch(error => {
                    console.log("Audio play blocked.");
                });
                ...
                addMessage("Ryōshū", `Could’ve been more <b>beautiful</b>. You gambled... and won ${winAmount} <b>Lunacy</b>!`, "bot", SANCHO_ICON);
                stopAllSFX();
                susuWinSound.play().catch(error => {
                    console.log("Audio play blocked.");
                });
                ...
                addMessage("Ryōshū", "Could’ve been more <b>beautiful</b>. You gambled... and won an item: <b>1-Pull Extraction Ticket</b>!", "bot", SANCHO_ICON);
                stopAllSFX();
                susuWinSound.play().catch(error => {
                    console.log("Audio play blocked.");
                });
                ...
                addMessage("Ryōshū", "Could’ve been more <b>beautiful</b>. You gambled... and won an item: <b>10-Pull Extraction Ticket</b>!", "bot", SANCHO_ICON);
                stopAllSFX();
                susuWinSound.play().catch(error => {
                    console.log("Audio play blocked.");
                });
        ...
        setTimeout(() => {
            ...
            if (amount > 10) {
                addMessage("Ryōshū", "What a waste of <b>time</b>. You can only extract <b>10 extractions</b> at a time!", "bot", SANCHO_ICON);
                stopAllSFX();
                susuLimitSound.play().catch(error => {
                    console.log("Audio play blocked.");
                });
                return;
            }
            ...
            if (args[1] === "1-pull") {
                if ((inv["1-Pull Extraction Ticket"] || 0) >= 1) {
                    ...
                    addMessage("Ryōshū", "Don’t bother me if you aren’t having any <b>1-Pull Tickets</b>.", "bot", SANCHO_ICON);
                    stopAllSFX();
                    susuNotEnoughSound.play().catch(error => {
                        console.log("Audio play blocked.");
                    });
                ...
                if ((inv["10-Pull Extraction Ticket"] || 0) >= 1) {
                    ...
                    addMessage("Ryōshū", "Don’t bother me if you aren’t having any <b>10-Pull Tickets</b>.", "bot", SANCHO_ICON);
                    stopAllSFX();
                    susuNotEnoughSound.play().catch(error => {
                        console.log("Audio play blocked.");
                    });
                ...
                if (getBalance() >= cost) {
                    ...
                    addMessage("Ryōshū", "Don’t bother me if you aren’t having any <b>Lunacy</b>.", "bot", SANCHO_ICON);
                    stopAllSFX();
                    susuNotEnoughSound.play().catch(error => {
                        console.log("Audio play blocked.");
                    });
        ...
        if (activeQuest) {
            ...
            addMessage("Ryōshū", "You are already under a Prescript.", "bot", SANCHO_ICON);
            return;
        }
        ...
        setTimeout(() => {
            ...
            addMessage("Ryōshū", `${quest.text}`, "bot", SANCHO_ICON);
        ...
        setTimeout(() => {
            const helpText = `
            Brought a <b>light</b>? <b>AVAILABLE COMMANDS:</b><br><br>
        ...
        `;
            addMessage("Ryōshū", helpText, "bot", SANCHO_ICON);
            stopAllSFX();
            susuHelpSound.play().catch(error => {
                console.log("Audio play blocked.");
            });
        }, 500);
    }
        ...
        if (adminUser.email === "khangcraftvn@gmail.com") {
            ...
            if (targetEmail === "khangcraftvn@gmail.com") {
                addMessage("Ryōshū", "Operation Denied. Protected administrative accounts cannot be banned.", "bot", SANCHO_ICON);
                return;
            }
            const targetUser = users.find(u => u.email === targetEmail);
        ...
        if (users[currentUserIndex].email === "khangcraftvn@gmail.com") {
            ...
            if (targetUser && !isNaN(amount)) {
                ...
                saveUserData();
                addMessage("Ryōshū", `It’s been a while since I saw art worth appraising. All I see these days are cheap imitations. Hmph. Sent <b>${amount} Lunacy</b> for <b>${targetEmail}</b>.`, "bot", SANCHO_ICON);
                stopAllSFX();
                susuAdminGiveSound.play().catch(error => {
                    console.log("Audio play blocked.");
                });
            }
        }
        ...
        if (users[currentUserIndex].email === "khangcraftvn@gmail.com") {
            ...
            if (targetUser && !isNaN(amount)) {
                ...
                saveUserData();
                addMessage("Ryōshū", `It’s been a while since I saw art worth appraising. All I see these days are cheap imitations. Hmph. Sent <b>${amount} 1-Pull Extraction Ticket(s)</b> for <b>${targetEmail}</b>.`, "bot", SANCHO_ICON);
                stopAllSFX();
                susuAdminGiveSound.play().catch(error => {
                    console.log("Audio play blocked.");
                });
        ...
        if (users[currentUserIndex].email === "khangcraftvn@gmail.com") {
            ...
            if (targetUser && !isNaN(amount)) {
                ...
                saveUserData();
                addMessage("Ryōshū", `It’s been a while since I saw art worth appraising. All I see these days are cheap imitations. Hmph. Sent <b>${amount} 10-Pull Extraction Ticket(s)</b> for <b>${targetEmail}</b>.`, "bot", SANCHO_ICON);
                stopAllSFX();
                susuAdminGiveSound.play().catch(error => {
                    console.log("Audio play blocked.");
                });
...
window.addEventListener('DOMContentLoaded', () => {
    setTimeout(() => {
        if (currentUserIndex !== -1 && users[currentUserIndex].adminNotification) {
            addMessage("Ryōshū", users[currentUserIndex].adminNotification, "bot", SANCHO_ICON);
    ...
    setTimeout(() => {
        ...
        if (currentUserIndex !== -1 && !users[currentUserIndex].adminNotification) {
            const greeting = "What are you meandering about for so early? Looking for <b>batteries</b>?";
            addMessage("Ryōshū", greeting, "bot", SANCHO_ICON);
        }
    }, 1000);
});
